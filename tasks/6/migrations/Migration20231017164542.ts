...
export class Migration20231017164542 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "product_entity" ("id" varchar(255) not null, "created_at" varchar(255) not null, "updated_at" varchar(255) not null, "title" varchar(255) not null, "description" varchar(255) not null, "price" int not null, constraint "product_entity_pkey" primary key ("id"));');
    ...
    this.addSql('create table "cart_entity" ("id" varchar(255) not null, "created_at" varchar(255) not null, "updated_at" varchar(255) not null, "user_id" varchar(255) not null, "is_deleted" boolean not null, constraint "cart_entity_pkey" primary key ("id"));');
    ...
    this.addSql('create table "order_entity" ("id" varchar(255) not null, "created_at" varchar(255) not null, "updated_at" varchar(255) not null, "user_id" varchar(255) not null, "cart_id" varchar(255) null, "items_id" varchar(255) not null, "payment" varchar(255) not null, "delivery" varchar(255) not null, "comments" varchar(255) not null, "status" varchar(255) not null, "total" int not null, constraint "order_entity_pkey" primary key ("id"));');
